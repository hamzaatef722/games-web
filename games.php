...
<head>
    ...
    <meta name="description"
        content="Explore the Games Review collection and find detailed game picks, ratings, and highlights across popular genres.">
 <link rel="preconnect" href="https://fonts.googleapis.com">
    ...
    <title>Games | Games Review</title>
</head>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active nav-active-link" href="games.php" aria-current="page" style="color: var(--primary-purple) !important;">GAMES</a>
                    </li>
                    <li class="nav-item">
